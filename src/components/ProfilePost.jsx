            ...
            <ModalContent>
                ...
                <ModalBody bg={"white"} pb={5}>
                    <Flex gap={4} w={{ base: "90%", sm: "70%", md: "full" }} mx={"auto"}>
                        <Box borderRadius={4} overflow={"hidden"} border={"1px soild"} borderColor={"blackAlpha.200"} flex={1.5}>
                            <Image src={img} alt="profile post" />
                        </Box>
                        <Flex flex={1} flexDir={"column"} px={10} display={{ base: "none", md: "flex"}}>
                            <Flex alignContent={"center"} justifyContent={"space-between"}>
                                <Flex alignItems={"center"} gap={4}>
                                    <Avatar src="/profilepic.jpg" size={"sm"} name="hyewonb" />
                            ...
                            <VStack w={"full"} alignItems={"start"} maxH={"350px"} overflowY={"auto"}>
                                <Comment createdAt="1d ago" username="hyewonb" profilePic="/profilepic.jpg" text={"Dummy images from unsplash"}/>
